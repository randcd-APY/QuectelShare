...
#define MHI_CTRL_FILE_NODE_OPEN_MAX_RETRY   1
...
#define ONE_SEC                             1
#define QTI_500MSEC_SLEEP                   500000 /*500 milliseconds*/
#define QTI_MAX_COMMAND_STR_LEN             300
#define QTI_MAX_PH_DRIVER                   2

#define QMI_IP_STA_FILE "/var/run/qmi_ip_sta"
#define QTI_PPP_LS_FILE "/var/run/qti_ppp_ls_uds_file"
...
#define MHI_DEV_CNTRL_FILE_SIZE             13
...
#define MHI_CTRL_DIR_NAME            "/dev"
#define MHI_CTRL_FILE_NAME           "mhi_ctrl"
...
#define HEX_DUMP_LOG_FILE            "/data/qti/log"
#define HEX_DUMP_QXDM_FILE           "/data/qti/qxdm"
#define HEX_DUMP_LOGS                "/data/qti/hex_dumps.txt"

#define MHI_DATA_INTERFACE "rmnet_mhi0"
#define USB_DATA_INTERFACE "usb_rmnet0"

#define HEX_DUMPS_FOLDER      "/data/qti"
...
#define MBIM_MODE_FILE                   "/etc/data/mbim_mode"
#define ADPL_NOTIFY_NODE                 "/etc/data/adpl/mhi_enable"
...
#define PRINT_MSG( level, fmtString, x, y, z) \
        if ( file_log_mode || hex_dumps_file_mode)     \
        {   \
...
#define HEXDUMP_QXDM_MSG(std,...) if( hex_dumps_qxdm_mode )       \
                                  { \
                                    QMI_DEBUG_MSG_1(std, ##__VA_ARGS__); \
                                  }
/*===========================================================================
