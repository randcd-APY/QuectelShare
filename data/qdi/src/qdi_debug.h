...
#elif defined(FEATURE_EXTERNAL_AP)
  #define  QDI_LOG_LOW(...) do {break;} while(0);
  #define  QDI_LOG_MED(...) do {break;} while(0);
  #define  QDI_LOG_HIGH(...) do {break;} while(0);
  #define  QDI_LOG_ERROR(...) do {break;} while(0);
  #define  QDI_LOG_FATAL(...) do {break;} while(0);
