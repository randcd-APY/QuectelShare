...
typedef void (*qcmap_msgr_backhaul_status_cb_fcn)
(
  void                                *user_data,              /* Call back User data */
  qcmap_cm_backhaul_status             backhaul_status         /* Backhaul Status */
);

typedef void (*qcmap_msgr_wwan_roaming_ind_cb_fcn)
(
  void                                     *user_data,            /* Call back User data */
  qcmap_msgr_wwan_roaming_status_enum_v01   wwan_roaming_status   /* Connection Status enum */
);
...
typedef struct
{
  ...
  qcmap_msgr_backhaul_status_cb_fcn     backhaul_status_cb;
  qcmap_msgr_wwan_roaming_ind_cb_fcn     wwan_roaming_cb;
