...
#define QMI_IP_IND_HDLR_FILE        "/var/run/qmi_ip_ind_hdlr_file"
#define QMI_IP_TUNNEL_MODULE_FILE   "/var/run/embms_tm_control_file"
#define QMI_IP_FPOP_FILE            "/var/run/qmi_ip_fpop_file"
#define QMI_IP_CONTROL_FILE         "/var/run/qmi_ip_control_file"
