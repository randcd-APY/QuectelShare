...
#define WEBCGI_WEBCLIENT_SOCK "/var/run/www/qcmap_webclient_cgi_file"
#define WEBCLIENT_WEBCGI_SOCK "/var/run/www/qcmap_cgi_webclient_file"
#define CHG_PERM_WEBCLIENT_WEBCGI_SOCK "chmod 777 " WEBCLIENT_WEBCGI_SOCK
                   ...
                   int *webcli_sockfd)
{
  ...
  /*d rwx rwx rwx = dec
    0 110 110 110 = 666
  */
  system(CHG_PERM_WEBCLIENT_WEBCGI_SOCK);
