...
#if !defined(FEATURE_DSUTILS_OFFTARGET) && !defined(FEATURE_EXTERNAL_AP)
...
static ds_target_t ds_get_target_from_soc_id()
{
  ...
  #elif defined(FEATURE_DATA_TARGET_FUSION_8096_9X55)
    target = DS_TARGET_FUSION_8096_9X55;
  #endif
      ...
      else
      {
        ...
        switch((int)soc_id)
        {
          ...
          case DS_TARGET_SOC_ID_SDX20:
            ...
            break;
          case DS_TARGET_SOC_ID_SDX24:
          case DS_TARGET_SOC_ID_SDX24M:
