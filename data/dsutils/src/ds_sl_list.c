...
DESCRIPTION
  ...
  Copyright (c) 2000, 2012, 2014, 2018 Qualcomm Technologies, Inc.
  All Rights Reserved.
...
===================================================================== */
static void ordered_list_push_after(
                                   ordered_list_type      *list_ptr,
...
DESCRIPTION
   ...
   Note: This function is not exported.
===================================================================== */
static void ordered_list_push_before(
                                    ordered_list_type      *list_ptr,
                                    ordered_list_link_type *item_to_push_ptr,
...
DESCRIPTION
   ...
   NOTE: This function is not exported.
===================================================================== */
static void ordered_list_append(
