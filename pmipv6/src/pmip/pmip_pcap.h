...
public_pmip_pcap(int pmip_send_qcmap_dev_query(int iifP, struct in6_addr *hw_addr,int is_v4_pmip_mode);)
public_pmip_pcap(int pmipv4_send_qcmap_mac_query(struct in6_addr *hw_addr);)
public_pmip_pcap(void ipv6_to_mac(const struct in6_addr * mac_v6, uint8_t *mac);)
public_pmip_pcap(void mac_to_ipv6(const uint8_t *mac, struct in6_addr * mac_v6);)
