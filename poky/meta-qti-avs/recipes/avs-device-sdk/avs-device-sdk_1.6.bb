...
SRC_URI = "https://github.com/alexa/avs-device-sdk/archive/v${PV}.tar.gz \
           ...
           file://0001-Adding-QTI-changes-in-MediaPlayer.patch \
           file://0001-Adding-QTI-SpeakerManager-changes.patch \
           file://0001-Fix-for-IDLE-wait-timeout.patch \
           file://0001-Notify-observers-imm-after-onPlaybackStarted-event.patch "
...
DEPENDS += "gstreamer1.0 gstreamer1.0-plugins-base gst-plugins"
...
do_fetch () {
#    /usr/bin/env wget --retry-connrefused -t 5 -T 30 -nv --passive-ftp --no-check-certificate -P ${WORKSPACE}/poky/build/downloads http://www.codeaurora.org/mirrored_source/quic/le/v1.6.tar.gz
    ls -al ${WORKSPACE}/poky/build/downloads/v1.6.tar.gz
}
