...
python do_getpatches() {
    ...
    cmd = "mkdir ${WORKSPACE}/poky/meta-ros/recipes-ros/tbb/tbb; cd ${WORKSPACE}/poky/meta-ros/recipes-ros/tbb/tbb \
    ...
    && (wget -c https://raw.githubusercontent.com/painterlake/meta-openembedded-my/master/meta-oe/recipes-support/tbb/tbb/tbb.pc || pwd)"
