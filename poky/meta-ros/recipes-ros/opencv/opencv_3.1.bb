...
python do_getpatches() {
    ...
    cmd = "cd ${WORKSPACE}/poky/meta-ros/recipes-ros/opencv/opencv \
    && (wget -c https://raw.githubusercontent.com/painterlake/meta-openembedded-my/master/meta-oe/recipes-support/opencv/opencv/0001-3rdparty-ippicv-Use-pre-downloaded-ipp.patch || pwd) \
    && (wget -c https://raw.githubusercontent.com/painterlake/meta-openembedded-my/master/meta-oe/recipes-support/opencv/opencv/fixgcc60.patch || pwd) \
    && (wget -c https://raw.githubusercontent.com/painterlake/meta-openembedded-my/master/meta-oe/recipes-support/opencv/opencv/fixpkgconfig.patch || pwd)"
