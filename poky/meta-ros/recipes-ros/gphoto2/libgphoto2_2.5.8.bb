...
DEPENDS = "libtool jpeg virtual/libusb0 libexif zlib libxml2 gettext"
...
python do_getpatches() {
    ...
    cmd = "mkdir ${WORKSPACE}/poky/meta-ros/recipes-ros/gphoto2/libgphoto2-2.5.8; cd ${WORKSPACE}/poky/meta-ros/recipes-ros/gphoto2/libgphoto2-2.5.8 \
    && (wget -c https://raw.githubusercontent.com/painterlake/meta-openembedded-my/master/meta-oe/recipes-graphics/gphoto2/libgphoto2-2.5.8/0001-configure.ac-remove-AM_PO_SUBDIRS.patch || pwd) \
    && (wget -c https://raw.githubusercontent.com/painterlake/meta-openembedded-my/master/meta-oe/recipes-graphics/gphoto2/libgphoto2-2.5.8/0002-correct-jpeg-memsrcdest-support.patch || pwd) \
    && (wget -c https://raw.githubusercontent.com/painterlake/meta-openembedded-my/master/meta-oe/recipes-graphics/gphoto2/libgphoto2-2.5.8/10-camera-libgphoto2-device.fdi || pwd) \
    && (wget -c https://raw.githubusercontent.com/painterlake/meta-openembedded-my/master/meta-oe/recipes-graphics/gphoto2/libgphoto2-2.5.8/10-camera-libgphoto2.fdi || pwd) \
    && (wget -c https://raw.githubusercontent.com/painterlake/meta-openembedded-my/master/meta-oe/recipes-graphics/gphoto2/libgphoto2-2.5.8/40-libgphoto2.rules || pwd) \
    && (wget -c https://raw.githubusercontent.com/painterlake/meta-openembedded-my/master/meta-oe/recipes-graphics/gphoto2/libgphoto2-2.5.8/avoid_using_sprintf.patch || pwd)"
