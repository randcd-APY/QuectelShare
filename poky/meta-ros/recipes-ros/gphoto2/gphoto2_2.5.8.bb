...
python do_getpatches() {
    ...
    cmd = "mkdir ${WORKSPACE}/poky/meta-ros/recipes-ros/gphoto2/gphoto2-2.5.8; cd ${WORKSPACE}/poky/meta-ros/recipes-ros/gphoto2/gphoto2-2.5.8 \
    && (wget -c https://raw.githubusercontent.com/painterlake/meta-openembedded-my/master/meta-oe/recipes-graphics/gphoto2/gphoto2-2.5.8/0001-configure.ac-remove-AM_PO_SUBDIRS.patch || pwd) \
    && (wget -c https://raw.githubusercontent.com/painterlake/meta-openembedded-my/master/meta-oe/recipes-graphics/gphoto2/gphoto2-2.5.8/0002-Look-for-popt-with-GP_CHECK_LIBRARY-function.patch || pwd)"
