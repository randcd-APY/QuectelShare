...
struct cmd_ch_map cmd_ch_map[GRAPHITE_CMD_MAX] = {
    {GRAPHITE_CMD_OPEN, "CONTROL_CHANNEL"},
    {GRAPHITE_CMD_CLOSE, "CONTROL_CHANNEL"},
    {GRAPHITE_CMD_SET_CONFIG, "CONTROL_CHANNEL"},
    {GRAPHITE_CMD_GET_CONFIG, "CONTROL_CHANNEL"},
    {GRAPHITE_CMD_LOAD_DATA, "PERSIST_CHANNEL"},
    {GRAPHITE_CMD_UNLOAD_DATA, "CONTROL_CHANNEL"},
    {GRAPHITE_CMD_DATA, "DATA_CHANNEL"},
};
#else
struct cmd_ch_map cmd_ch_map[GRAPHITE_CMD_MAX] = {
...
#ifdef BG_KWD
                 len = strlcpy(pkt->ch_name, "PERSIST_CHANNEL",
