...
============================================================================*/
#ifndef __ABF44_REG_H__
#define __ABF44_REG_H__
...
#define ISP_ABF3_OFF 0x00000A34
#define ISP_ABF3_LEN 27

#define WTABLE_ADJ_VAL 5

#define SHORT_NOISE_SCALE 1

#define NOISE_OFFSET_MAX_VAL (1<<12) - 1

#define DENOISE_STRENGTH_MAX_VAL 255

#define NOISE_OFFSET_SCALE 1
...
typedef struct ISP_ABF3_ChannelCfg {
  ...
  /*   CFG_1  */
  uint32_t    gr_noiseScale1Lv0            : 12;
  uint32_t    /* reserved */            :  4;
  uint32_t    gr_noiseScale1Lv1            : 12;
  uint32_t    /* reserved */            :  4;
  /*   CFG_2  */
  ...
  uint32_t    /* reserved */            :  4;
  /*   CFG_3  */
  uint32_t    gr_noiseOffLv0               : 12;
  uint32_t    /* reserved */            :  4;
  uint32_t    gr_noiseOffLv1               : 12;
  uint32_t    /* reserved */            :  4;
  /*   CFG_4  */
  uint32_t    gr_filterStrLv0              :  8;
  uint32_t    gr_filterStrLv1              :  8;
  ...
  /*   CFG_1  */
  uint32_t    gb_noiseScale1Lv0            : 12;
  uint32_t    /* reserved */            :  4;
  uint32_t    gb_noiseScale1Lv1            : 12;
  uint32_t    /* reserved */            :  4;
  /*   CFG_2  */
  ...
  uint32_t    /* reserved */            :  4;
  /*   CFG_3  */
  uint32_t    gb_noiseOffLv0               : 12;
  uint32_t    /* reserved */            :  4;
  uint32_t    gb_noiseOffLv1               : 12;
  uint32_t    /* reserved */            :  4;
  /*   CFG_4  */
  uint32_t    gb_filterStrLv0              :  8;
  uint32_t    gb_filterStrLv1              :  8;
  ...
  /*   CFG_1  */
  uint32_t    r_noiseScale1Lv0            : 12;
  uint32_t    /* reserved */            :  4;
  uint32_t    r_noiseScale1Lv1            : 12;
  uint32_t    /* reserved */            :  4;
  /*   CFG_2  */
  ...
  uint32_t    /* reserved */            :  4;
  /*   CFG_3  */
  uint32_t    r_noiseOffLv0               : 12;
  uint32_t    /* reserved */            :  4;
  uint32_t    r_noiseOffLv1               : 12;
  uint32_t    /* reserved */            :  4;
  /*   CFG_4  */
  uint32_t    r_filterStrLv0              :  8;
  uint32_t    r_filterStrLv1              :  8;
  ...
  /*   CFG_1  */
  uint32_t    b_noiseScale1Lv0            : 12;
  uint32_t    /* reserved */            :  4;
  uint32_t    b_noiseScale1Lv1            : 12;
  uint32_t    /* reserved */            :  4;
  /*   CFG_2  */
  ...
  uint32_t    /* reserved */            :  4;
  /*   CFG_3  */
  uint32_t    b_noiseOffLv0               : 12;
  uint32_t    /* reserved */            :  4;
  uint32_t    b_noiseOffLv1               : 12;
  uint32_t    /* reserved */            :  4;
  /*   CFG_4  */
  uint32_t    b_filterStrLv0              :  8;
  uint32_t    b_filterStrLv1              :  8;
