...
#define ISP_LTM_CFG_OFF     0x000009D0
#define ISP_LTM_STATUS_OFF  0x000009D4
#define ISP_LTM_H_SCALE_OFF 0x000009D8
#define ISP_LTM_V_SCALE_OFF 0x000009E8
#define ISP_LTM_DCIP_OFF    0x000009FC
#define ISP_LTM_RGB2Y_OFF   0x00000A14
#define ISP_LTM_H_PAD_OFF   0x000009E4
#define ISP_LTM_V_PAD_OFF   0x000009F8
...
/* LTM_SCALE_H_IMAGE_SIZE_CFG = 0x09D8 */
...
/* LTM_SCALE_V_IMAGE_SIZE_CFG = 0x09E8 */
...
/* LTM_SCALE_V_IMAGE_SIZE_CFG = 0x09E8 */
typedef struct ISP_LTMScaleVEmptyCfg {
  uint32_t /* reserved */          :8;
  uint32_t /* reserved */          :8;
  uint32_t /* reserved */          :8;
  uint32_t /* reserved */          :8;
} __attribute__((packed, aligned(4))) ISP_LTMScaleVEmptyCfg;

/* LTM_SCALE_V_PHASE_CFG = 0x09F0 */
...
/* LTM_IP_INV_CELLWIDTH_CFG = 0x0A04 */
...
/* LTM_IP_INV_CELLHEIGHT_CFG = 0x0A08 */
...
/* LTM_IP_INV_CELLHEIGHT_CFG = 0x0A10 */
...
/* LTM_RGB2Y_CFG1 = 0x0A18 */
typedef struct ISP_LTMRGB2YCfg1 {
  uint32_t thr                     :10;
  uint32_t /* reserved */          :6;
  uint32_t k                       :10;
  uint32_t c4 /* reserved */       :6;  /* This variable is added to be parallel with 8994 */
} __attribute__((packed, aligned(4))) ISP_LTMRGB2YCfg1;

/* ######################### PADDING REGISTERS ###################### */

/* LTM_SCALE_H_PAD_CFG = 0x09E4 */
