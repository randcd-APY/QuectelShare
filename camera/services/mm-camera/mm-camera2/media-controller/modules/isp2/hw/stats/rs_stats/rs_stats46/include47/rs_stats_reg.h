...
#define RS_STATS_OFF 0x00000BEC
#define RS_STATS_LEN 3

#define ISP_STATS_RS_BUF_NUM  4
/* RS stats47 1024x16 total number of 16-bit outputs */
#define ISP_STATS_RS_BUF_SIZE (1024 * 16) * 2

#define STATS_CFG_OFF 0x00000AB0
#define STATS_LEN 1

#define RS_MAX_V_REGIONS 1024
#define RS_MAX_H_REGIONS 16

#define RS_MAX_RGN_HEIGHT 16
#define RS_MAX_SHIFT_BIT  13
