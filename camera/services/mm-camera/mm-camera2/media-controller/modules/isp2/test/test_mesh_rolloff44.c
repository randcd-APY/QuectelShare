...
#include "rolloff/mesh_rolloff44/mesh_rolloff44.h"
...
/* Bank Select bit need not be validated*/
  ...
  VALIDATE_TST_VEC(in->num_meshgain_h, out->num_meshgain_h, 0, "numMeshGainH");
  VALIDATE_TST_VEC(in->num_meshgain_v, out->num_meshgain_v, 0, "numMeshGainV");
  ...
  void *test_output)
{
  ...
  size = (in.num_meshgain_h+ 2) * (in.num_meshgain_v + 2);
