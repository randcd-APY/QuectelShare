...
#include "black_level/black_level47/black_level47.h"
...
int vfe_black_level_tv_validate(void *input, void *output)
{
  ...
  /*Black level on stats system team doesn support yet*/
 /* VALIDATE_TST_VEC(in_stats->offset, out_stats->offset, 0, "offset");
  VALIDATE_TST_VEC(in_stats->scale, out_stats->scale, 0, "scale"); */
