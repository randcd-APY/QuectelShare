...
static boolean af_cmixer_get_parameters(af_alg_interface_t *p_alg,
...
/** af_cmixer_rebase_monitor:
*   Notification of focus search end & reset any reference
*   parameters if required.
*
*  Return: TRUE on success else FALSE
**/
boolean af_cmixer_rebase_monitor(af_alg_interface_t *p_alg)
{
  ...
  if(pMixer->p_tof_alg->process_search){
    result = pMixer->p_tof_alg->rebase_monitor(pMixer->p_tof_alg);
  }

  if(pMixer->p_pdaf_alg->process_search){
    result = pMixer->p_pdaf_alg->rebase_monitor(pMixer->p_pdaf_alg);
  }
...
af_alg_interface_t* af_alg_CMIXER_create(af_alg_util_interface_t *p_alg_util_instance)
{
  ...
  p_CMIXER_instance->af_alg.get_parameters      = af_cmixer_get_parameters;
  ...
  p_CMIXER_instance->af_alg.rebase_monitor      = af_cmixer_rebase_monitor;
...
/** af_cmixer_get_parameters:
*Retrieve information from Algo.
*
*@p_alg : af_alg_interface pointer.
*@param : Information to be retrieved.
*Return: boolean SUCCESS/FAIL
**/
boolean af_cmixer_get_parameters(af_alg_interface_t *p_alg, af_haf_get_parameter_t *param)
{
  (void)p_alg;
  (void)param;
