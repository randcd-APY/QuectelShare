 ...
 **/
q3a_thread_af_msg_t* af_fdprio_create_msg(int msg_type,
  int param_type, af_fdprio_t *af_port)
{
...
static boolean af_fdprio_send_default_roi(af_fdprio_t *af_fdprio_data) {
  ...
  q3a_thread_af_msg_t *af_msg =
    af_fdprio_create_msg(MSG_AF_SET, AF_SET_PARAM_ROI, af_fdprio_data);
  if (af_msg == NULL) {
    return FALSE;
  }
