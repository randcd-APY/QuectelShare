...
typedef boolean    (* afd_module_process_func)(q3a_core_bg_stats_type *bg_stats,
  q3a_core_row_sum_stats_type *row_sum_stats, void *afd_obj, afd_output_data_t *output);
