 ...
 *  Static functions
 **/
static int32_t module_ppdgcore_client_created(imgbase_client_t *p_client);
static int32_t module_ppdgcore_client_destroy(imgbase_client_t *p_client);
static int32_t module_ppdgcore_client_streamon(imgbase_client_t * p_client);
static int32_t module_ppdgcore_client_prestreamoff( imgbase_client_t * p_client,
  uint32_t identity);
static int32_t module_ppdgcore_client_flush_done( imgbase_client_t * p_client,
  imgbase_stream_t *p_stream);
static int32_t module_ppdgcore_update_meta(imgbase_client_t *p_client,
  img_meta_t *p_meta);
static boolean module_ppdgcore_handle_stream_crop_event(uint32_t identity,
  mct_event_module_t *p_mod_event, imgbase_client_t *p_client,
  img_core_ops_t *p_core_ops, boolean *is_evt_handled);
static boolean module_ppdgcore_handle_isp_out_dim_event(uint32_t identity,
  mct_event_module_t *p_mod_event,
  imgbase_client_t *p_client, img_core_ops_t *p_core_ops, boolean *is_evt_handled);
static boolean module_ppdgcore_handle_dg_config_event(uint32_t identity,
  mct_event_module_t *p_mod_event,
  imgbase_client_t *p_client, img_core_ops_t *p_core_ops, boolean *is_evt_handled);
static boolean module_ppdgcore_handle_dis_update_event(uint32_t identity,
  mct_event_module_t *p_mod_event,
  imgbase_client_t *p_client, img_core_ops_t *p_core_ops, boolean *is_evt_handled);
static boolean module_ppdgcore_handle_dewrap_update_event(uint32_t identity,
  mct_event_module_t *p_mod_event,
  imgbase_client_t *p_client, img_core_ops_t *p_core_ops, boolean *is_evt_handled);
static boolean module_ppdgcore_handle_iface_request_pp_divert_event(
  uint32_t identity, mct_event_module_t *p_mod_event, imgbase_client_t *p_client,
  img_core_ops_t *p_core_ops, boolean *is_evt_handled);
static int32_t module_ppdgcore_handle_meta_stream_info(mct_event_control_parm_t
  *p_ctrl_parm, imgbase_client_t *p_client, img_core_ops_t *p_core_ops);


/** g_caps:
 *
 *  Set the capabilities for Ppdgcore (PPDGCORE) module
*/
...
static module_imgbase_params_t g_params = {
  .imgbase_client_created = module_ppdgcore_client_created,
  .imgbase_client_destroy = module_ppdgcore_client_destroy,
  .imgbase_client_pre_streamoff = module_ppdgcore_client_prestreamoff,
  .imgbase_client_flush_done = module_ppdgcore_client_flush_done,
  .imgbase_client_streamon = module_ppdgcore_client_streamon,
  .imgbase_handle_module_event[MCT_EVENT_MODULE_STREAM_CROP] =
    module_ppdgcore_handle_stream_crop_event,
  .imgbase_handle_module_event[MCT_EVENT_MODULE_ISP_OUTPUT_DIM] =
    module_ppdgcore_handle_isp_out_dim_event,
  .imgbase_handle_module_event[MCT_EVENT_MODULE_ISP_DIS_CONFIG] =
    module_ppdgcore_handle_dg_config_event,
  .imgbase_handle_module_event[MCT_EVENT_MODULE_STATS_DIS_UPDATE] =
    module_ppdgcore_handle_dis_update_event,
  .imgbase_handle_module_event[MCT_EVENT_MODULE_STATS_DEWARP_UPDATE] =
    module_ppdgcore_handle_dewrap_update_event,
  .imgbase_handle_module_event[ MCT_EVENT_MODULE_IFACE_REQUEST_PP_DIVERT] =
    module_ppdgcore_handle_iface_request_pp_divert_event,
  .imgbase_handle_ctrl_parm[CAM_INTF_META_STREAM_INFO] =
    module_ppdgcore_handle_meta_stream_info,
  .imgbase_client_update_meta = module_ppdgcore_update_meta,
...
/**
 * Function: module_ppdgcore_client_created
 *
 ...
 * Notes: none
 **/
int32_t module_ppdgcore_client_created(imgbase_client_t *p_client)
{
  ...
  p_client->feature_mask = CAM_QTI_FEATURE_PPDGCORE;

  IDBG_INFO("feature mask: 0x%llx", p_client->feature_mask);
...
/**
 * Function: module_ppdgcore_client_streamon
 *
...
/**
 * Function: module_ppdgcore_client_prestreamoff
 *
 ...
 * Notes: none
 **/
static int32_t module_ppdgcore_client_prestreamoff(
imgbase_client_t * p_client, uint32_t identity)
{
  ...
  IDBG_INFO(" E got it , queued %d !!", p_client->meta_hold_q.count);
...
/**
 * Function: module_ppdgcore_client_flush_done
 *
 ...
 * Notes: none
 **/
int32_t module_ppdgcore_client_flush_done( imgbase_client_t * p_client,
  imgbase_stream_t *p_stream) {
  IDBG_INFO("Flush done indication!");
...
/**
 * Function: module_ppdgcore_client_destroy
 *
 ...
 * Notes: none
 **/
int32_t module_ppdgcore_client_destroy(imgbase_client_t *p_client)
{
  IDBG_INFO("%s:%d: E", __func__, __LINE__);
...
/**
 * Function: module_ppdgcore_handle_meta_stream_info
 *
  ...
  *p_ctrl_parm, imgbase_client_t *p_client, img_core_ops_t *p_core_ops)
{
  ...
  for (i = 0; i < meta_stream_info->num_streams; i++) {
    IDBG_INFO("META_STREAM_INFO type = %d w x h : %d x %d pp_mask = 0x%llx",
 ...
 * Notes: none
 **/
boolean module_ppdgcore_handle_stream_crop_event(uint32_t identity,
  mct_event_module_t *p_mod_event, imgbase_client_t *p_client,
  img_core_ops_t *p_core_ops, boolean *is_evt_handled)
{
  // int rc = IMG_SUCCESS;
 ...
 * Notes: none
 **/
boolean module_ppdgcore_handle_isp_out_dim_event(uint32_t identity,
  mct_event_module_t *p_mod_event, imgbase_client_t *p_client,
  img_core_ops_t *p_core_ops, boolean *is_evt_handled)
{
  ...
  *is_evt_handled = FALSE;
  ...
  IDBG_INFO("dewarp_type %d and is_type %d",
    p_stream->stream_info->dewarp_type,p_stream->stream_info->is_type);

  if(p_stream->stream_info->is_type != IS_TYPE_DIG_GIMB) {
      fwd_event = TRUE;
  } else {
    p_comp = &p_client->comp;
    if (p_comp) {
      img_dim_t *in_dim = malloc(sizeof(img_dim_t));
      if (in_dim) {
        img_lib_config_t lib_config;
        in_dim->width  = stream_info->dim.width;
        in_dim->height = stream_info->dim.height;
        in_dim->stride = stream_info->buf_planes.plane_info.mp[0].stride;
        in_dim->scanline = stream_info->buf_planes.plane_info.mp[0].scanline;
        lib_config.lib_data = (void *)in_dim;
        lib_config.lib_param = IMG_ALGO_IN_FRAME_DIM;
        rc = IMG_COMP_SET_PARAM(p_comp, QIMG_PARAM_LIB_CONFIG,
          &lib_config);
        if (IMG_ERROR(rc)) {
          IDBG_ERROR("Fail to set output dimentions");
          rc = IMG_ERR_INVALID_OPERATION;
        }
      } else {
        IDBG_ERROR("Cannot allocate structure!");
      }
    } else {
      IDBG_ERROR("No img component!");
    }
  }
...
/**
 * Function: ppdgcore_find_max_stream_dimension
 *
 * Description: This function finds the maximum stream dimension
 *
 * Arguments:
 *   p_client - imgbase client
 *   width - pointer of output width
 *   height - pointer of output height
 *
 * Return values:
 *     none
 *
 * Notes: none
 **/
static void ppdgcore_find_max_stream_dimension(
  imgbase_client_t *p_client, uint32_t *width, uint32_t *height)
{
  imgbase_stream_t *p_stream = NULL;
  mct_stream_info_t *stream_info = NULL;
  uint32_t i;
  ...
  for (i = 0; i < p_client->stream_cnt; i++) {
    ...
    stream_info = p_stream->stream_info;
    IDBG_INFO("Dump: stream_type %d, width %d, height %d",
        stream_info->stream_type, stream_info->dim.width, stream_info->dim.height);
    if (stream_info->dim.width >= max_width && stream_info->dim.height >= max_height) {
      max_width = stream_info->dim.width;
      max_height = stream_info->dim.height;
    }
  }
  *width = max_width;
  *height = max_height;
...
/**
 * Function: ppdgcore_update_stream_dimensions
 *
 ...
 * Notes: none
 **/
static int32_t ppdgcore_update_stream_dimensions(
...
boolean module_ppdgcore_handle_dg_config_event(uint32_t identity,
  mct_event_module_t *p_mod_event, imgbase_client_t *p_client,
  img_core_ops_t *p_core_ops, boolean *is_evt_handled)
{
  ...
  *is_evt_handled = TRUE;
  ...
  IDBG_INFO(" MCT_EVENT_MODULE_ISP_DIS_CONFIG , sid = %u, strid = %x, "
  ...
  //Modify config in multi-stream cases,
  //for example, 2 video streams, or preview + video streams.
  //Maximum output resolution is chosen and configured to CPP input.
  ppdgcore_find_max_stream_dimension(p_client, &dis_config->width, &dis_config->height);
  IDBG_INFO(" MCT_EVENT_MODULE_ISP_DIS_CONFIG , new w = %u, h = %u",
    dis_config->width, dis_config->height);
  ...
  ppdgcore_update_stream_dimensions(p_stream, dis_config);

  IDBG_INFO("A Strm Info dim %dX%d strXsca %dX%d \n", p_stream->stream_info->dim.width,
    p_stream->stream_info->dim.height, p_stream->stream_info->buf_planes.plane_info.mp[0].stride,
    p_stream->stream_info->buf_planes.plane_info.mp[0].scanline,
    p_stream->stream_info->buf_planes.plane_info.frame_len);
  ...
  IDBG_INFO("stream type %d, width %d, height %d num planes %d",
  ...
  for (i = 0; i < stream_info->buf_planes.plane_info.num_planes; i++) {
    ...
    new_out_stream_info.buf_planes.plane_info.frame_len +=
      stream_info->buf_planes.plane_info.mp[i].len;
    IDBG_INFO("new plane %d, stride %d, scanline %d,"
  ...
  if(p_stream->stream_info->is_type == IS_TYPE_DIG_GIMB) {
    ...
    img_dim_t *out_dim = malloc(sizeof(img_dim_t));
    if (out_dim) {
      img_lib_config_t lib_config;

      out_dim->width = dis_config->width;
      out_dim->height = dis_config->height;
      out_dim->stride = new_out_stream_info.buf_planes.plane_info.mp[0].stride;
      out_dim->scanline = new_out_stream_info.buf_planes.plane_info.mp[0].scanline;

      lib_config.lib_data = (void *)out_dim;
...
/**
 * Function: module_ppdgcore_handle_dis_update_event
 *
 ...
 * Notes: none
 **/
boolean module_ppdgcore_handle_dis_update_event(uint32_t identity,
  mct_event_module_t *p_mod_event, imgbase_client_t *p_client,
  img_core_ops_t *p_core_ops, boolean *is_evt_handled)
{
  int rc = IMG_SUCCESS;
  ...
  *is_evt_handled = TRUE;
  ...
  rc = mod_imgbase_send_event( is_update->id, TRUE,
    MCT_EVENT_MODULE_IS_CONFIG, is_config);

  p_stream->eis_config.eis_num_mesh_x = is_config.num_mesh_x + 1;
  p_stream->eis_config.eis_num_mesh_y = is_config.num_mesh_y + 1;

  }

  IDBG_INFO("Matrix 1 : %f %f %f | %f %f %f | %f %f %f ",
...
/**
 * Function: module_ppdgcore_handle_dewrap_update_event
 *
 ...
 * Notes: none
 **/
boolean module_ppdgcore_handle_dewrap_update_event(uint32_t identity,
  mct_event_module_t *p_mod_event, imgbase_client_t *p_client,
  img_core_ops_t *p_core_ops, boolean *is_evt_handled)
{
  img_component_ops_t *p_comp = NULL;
  ...
  *is_evt_handled = TRUE;
  ...
  IDBG_INFO("Got Dewarp update event for id %x",identity);
...
boolean module_ppdgcore_handle_iface_request_pp_divert_event(
  uint32_t identity, mct_event_module_t *p_mod_event, imgbase_client_t *p_client,
  img_core_ops_t *p_core_ops, boolean *is_evt_handled)
{
  int rc = IMG_SUCCESS;
  ...
  *is_evt_handled = FALSE;
  ...
  IDBG_LOW("PP divert request event - X");

  return fwd_event;
}

/**
 * Function: module_ppdgcore_update_meta
 *
 ...
 * Notes: none
 **/
int32_t module_ppdgcore_update_meta(imgbase_client_t *p_client,
  img_meta_t *p_meta)
{
...
/**
 * Function: module_ppdgcore_deinit
 *
...
mct_module_t *module_ppdgcore_init(const char *name)
{
  ...
  return module_imgbase_init(name,
    ...
    NULL,
    &g_caps,
    "libmmcamera_ppdgcore.so",
    CAM_QTI_FEATURE_PPDGCORE,
    &g_params);
}


/** module_ppdgcore_set_parent:
 *
 *  Arguments:
 ...
 * Notes: none
 **/
void module_ppdgcore_set_parent(mct_module_t *p_mct_mod, mct_module_t *p_parent)
{
