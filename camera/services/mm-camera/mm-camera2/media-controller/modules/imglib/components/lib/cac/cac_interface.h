...
#define CAC_ERROR                    (1)
#define CAC_TRUE          ((uint32_t)(1))
#define CAC_FALSE         ((uint32_t)(0))
typedef struct
{
    ...
    uint8_t dynamicThEnable;   //Dynamic threshold enable flag 0- disable 1-enable
} cac_arg_t;


uint32_t cac_module_process( cac_arg_t * p_args);
