...
LOCAL_SRC_FILES := QCameraPPEisCore.cpp QCameraBufferMap.cpp

LOCAL_SHARED_LIBRARIES += libdl libcutils liblog libgui libEGL libGLESv2 libhardware libqdMetaData libutils libui libmmcamera_dbg libmmcamera_imglib
