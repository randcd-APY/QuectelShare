IMX477_CHROMATIX_HFR_90_CPP_PATH := $(call my-dir)
...
include $(CLEAR_VARS)
LOCAL_PATH := $(IMX477_CHROMATIX_HFR_90_CPP_PATH)
...
LOCAL_SRC_FILES:= chromatix_imx477_hfr_90_cpp.c

LOCAL_MODULE           := libchromatix_imx477_cpp_hfr_90
