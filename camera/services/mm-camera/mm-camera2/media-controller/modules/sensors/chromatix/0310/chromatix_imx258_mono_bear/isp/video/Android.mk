IMX258_MONO_BEAR_CHROMATIX_VIDEO_PATH := $(call my-dir)
...
include $(CLEAR_VARS)
LOCAL_PATH := $(IMX258_MONO_BEAR_CHROMATIX_VIDEO_PATH)
...
LOCAL_C_INCLUDES += chromatix_imx258_mono_bear_video.h

LOCAL_SRC_FILES:= chromatix_imx258_mono_bear_video.c
