IMX477_CHROMATIX_SW_POST_PROC_PATH := $(call my-dir)
...
include $(CLEAR_VARS)
LOCAL_PATH := $(IMX477_CHROMATIX_SW_POST_PROC_PATH)
...
LOCAL_SRC_FILES:= chromatix_imx477_sw_post_proc.c

LOCAL_MODULE           := libchromatix_imx477_postproc
