IMX477_CHROMATIX_VIDEO_PATH := $(call my-dir)
...
include $(CLEAR_VARS)
LOCAL_PATH := $(IMX477_CHROMATIX_VIDEO_PATH)
...
LOCAL_SRC_FILES:= chromatix_imx477_video.c

LOCAL_MODULE           := libchromatix_imx477_video
