IMX477_CHROMATIX_HFR_60_PATH := $(call my-dir)
...
include $(CLEAR_VARS)
LOCAL_PATH := $(IMX477_CHROMATIX_HFR_60_PATH)
...
LOCAL_SRC_FILES:= chromatix_imx477_hfr_60.c

LOCAL_MODULE           := libchromatix_imx477_hfr_60
