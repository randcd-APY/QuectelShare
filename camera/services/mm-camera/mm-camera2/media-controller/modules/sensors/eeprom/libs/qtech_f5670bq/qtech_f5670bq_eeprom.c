 ...
 * Return: void.
 **/
static void qtech_f5670bq_update_awb()
{
 ...
 **/
static int qtech_f5670bq_get_group_index(uint8_t mid)
{
  ...
  DEBUG_INFO("%s:group_index:%d",__func__,group_index);
  return group_index ;
}

/** qtech_f5670bq_read_info:
 *    @e_ctrl: point to sensor_eeprom_data_t of the eeprom device
 *
 ...
 **/
static int qtech_f5670bq_read_info(sensor_eeprom_data_t *e_ctrl)
{
  ...
  group_index=qtech_f5670bq_get_group_index(mid);
  if(group_index==-1){
 ...
 **/
static int qtech_f5670bq_read_wbdata(sensor_eeprom_data_t *e_ctrl)
{
  uint8_t mid ;
  uint8_t temp ;
  uint8_t reg_val  ;
 ...
 * Return: void.
 **/
static void qtech_f5670bq_format_wbdata(sensor_eeprom_data_t *e_ctrl)
{
  SLOW("Enter");
  int rc = 0;

  rc = qtech_f5670bq_read_wbdata(e_ctrl);
  if(rc < 0){
...
/** qtech_f5670bq_format_calibration_data:
 *    @e_ctrl: point to sensor_eeprom_data_t of the eeprom device
 *
...
void qtech_f5670bq_format_calibration_data(void *e_ctrl) {
  ...
  qtech_f5670bq_read_info(e_ctrl) ;
  qtech_f5670bq_format_wbdata(ectrl);
  SLOW("Exit");
}

/** qtech_f5670bq_get_raw_data:
 *    @e_ctrl: point to sensor_eeprom_data_t of the eeprom device
 ...
 **/
void* qtech_f5670bq_eeprom_open_lib(void) {
  return &qtech_f5670bq_lib_func_ptr;
}
