...
============================================================================*/
#include "sunny_gt24c64a_imx362_eeprom.h"

/** sunny_gt24c64a_imx362_eeprom_get_calibration_items:
...
/** sunny_gt24c64a_imx362_eeprom_get_module_info:
 *    @e_ctrl: point to sensor_eeprom_data_t of the eeprom device
 *
 *   Get Module detailes
 *
 ...
 * Return: void.
 **/
static void sunny_gt24c64a_imx362_eeprom_get_module_info(sensor_eeprom_data_t *e_ctrl)
{
  unsigned char flag;
...
/** sunny_gt24c64a_imx362_eeprom_format_wbdata:
 *    @e_ctrl: point to sensor_eeprom_data_t of the eeprom device
 *
 ...
 * Return: void.
 **/
static void sunny_gt24c64a_imx362_eeprom_format_wbdata(sensor_eeprom_data_t *e_ctrl)
{
  unsigned char flag;
  module_info_t *module_info;
  awb_data_t    *wb;
...
/** sunny_gt24c64a_imx362_eeprom_format_lensshading:
 *    @e_ctrl: point to sensor_eeprom_data_t of the eeprom device
 *
 ...
 * Return: void.
 **/
void sunny_gt24c64a_imx362_eeprom_format_lensshading(sensor_eeprom_data_t *e_ctrl)
{
  unsigned char  flag;
...
/** sunny_gt24c64a_imx362_eeprom_format_afdata:
 *    @e_ctrl: point to sensor_eeprom_data_t of the eeprom device
 *
 * Format the data structure of white balance calibration
 *
 ...
 * Return: void.
 **/
static void sunny_gt24c64a_imx362_eeprom_format_afdata(sensor_eeprom_data_t *e_ctrl)
{
  unsigned char    flag;
  af_data_t        *af;
...
static void sunny_gt24c64a_imx362_eeprom_format_pdafgain(sensor_eeprom_data_t *e_ctrl)
{
...
/** sunny_gt24c64a_imx362_eeprom_format_calibration_data:
 *    @e_ctrl: point to sensor_eeprom_data_t of the eeprom device
 *
...
void sunny_gt24c64a_imx362_eeprom_format_calibration_data(void *e_ctrl)
{
  ...
  sunny_gt24c64a_imx362_eeprom_get_module_info(ctrl);
  sunny_gt24c64a_imx362_eeprom_format_wbdata(ctrl);
  sunny_gt24c64a_imx362_eeprom_format_lensshading(ctrl);
  sunny_gt24c64a_imx362_eeprom_format_afdata(ctrl);
  sunny_gt24c64a_imx362_eeprom_format_pdafgain(ctrl);
}

/** sunny_gt24c64a_imx362_eeprom_eeprom_open_lib:
 *
 ...
 **/
void* sunny_gt24c64a_imx362_eeprom_open_lib(void) {
  return &sunny_gt24c64a_imx362_eeprom_lib_func_ptr;
}
