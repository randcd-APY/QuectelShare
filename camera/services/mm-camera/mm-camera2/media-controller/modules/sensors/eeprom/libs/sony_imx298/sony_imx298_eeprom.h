...
static eeprom_lib_func_t sony_imx298_eeprom_lib_func_ptr = {
  .get_calibration_items    = sony_imx298_eeprom_get_calibration_items,
  .format_calibration_data  = sony_imx298_eeprom_format_calibration_data,
  .do_af_calibration        = eeprom_autofocus_calibration,
  .do_wbc_calibration       = eeprom_whitebalance_calibration,
  .do_lsc_calibration       = NULL,
  .get_raw_data             = sony_imx298_eeprom_get_raw_data,
      ...
      {
        {
          ...
          .mem_settings =
          {
            { 0x0, CAMERA_I2C_WORD_ADDR,
              949, CAMERA_I2C_BYTE_DATA, CAMERA_I2C_OP_READ, 0 },
          },
          .memory_map_size = 1,
        },
      },
