...
#ifndef __IMX477_RAW12_LIB_H__
#define __IMX477_RAW12_LIB_H__
  ...
  .out_info_array =
  {
    .out_info =
    {
      /* Res 0 */
      {
        .x_output = 4056,
        .y_output = 3040,
        .line_length_pclk = 8932,
        .frame_length_lines = 3134,
        .vt_pixel_clk = 840000000,
        .op_pixel_clk = 385000000,
        .binning_factor = 1,
        .min_fps = 7.50,
        .max_fps = 30.01,
      ...
      /* Res 1 */
      {
        .x_output = 4056,
        .y_output = 2288,
        .line_length_pclk = 9100,
        .frame_length_lines = 3080,
        .vt_pixel_clk = 840000000,
        .op_pixel_clk = 385000000,
        .binning_factor = 1,
        .min_fps = 7.50,
      ...
      /* Res 3 */
      {
        .x_output = 3040,
        .y_output = 3040,
        .line_length_pclk = 8092,
        .frame_length_lines = 3460,
        .vt_pixel_clk = 840000000,
      ...
      /* Res 4 */
      {
        .x_output = 1520,
        .y_output = 1520,
        .line_length_pclk = 4375,
        .frame_length_lines = 6400,
        .vt_pixel_clk = 840000000,
        .op_pixel_clk = 230000000,
        .binning_factor = 2,
        .min_fps = 7.50,
        .max_fps = 30.00,
        .mode = SENSOR_DEFAULT_MODE,
      ...
      /* Res 5 */
      {
        .x_output = 3840,
        .y_output = 2160,
        .line_length_pclk = 6324,
        .frame_length_lines = 2216,
        .vt_pixel_clk = 840000000,
      ...
      /* Res 6 */
      {
        .x_output = 1920,
        .y_output = 1080,
        .line_length_pclk = 6500,
        .frame_length_lines = 2156,
        .vt_pixel_clk = 840000000,
        .op_pixel_clk = 320000000,
        .binning_factor = 2,
        .min_fps = 7.50,
      ...
      /* Res 7 */
      {
        .x_output = 1920,
        .y_output = 1080,
        .line_length_pclk = 6468,
        .frame_length_lines = 1443,
        .vt_pixel_clk = 840000000,
        .op_pixel_clk = 320000000,
        .binning_factor = 2,
        .min_fps = 7.50,
      ...
      /* Res 8 */
      {
        ...
        .y_output = 720,
        .line_length_pclk = 6500,
        .frame_length_lines = 1078,
        .vt_pixel_clk = 840000000,
        .op_pixel_clk = 312000000,
        .binning_factor = 2,
        .min_fps = 7.50,
        .max_fps = 119.88,
        .mode = SENSOR_HFR_MODE,
