...
public:
  ...
  /** setDefaultHuffTables:
   *
   *  set default huff tables
   **/
  int setDefaultHuffTables();
   ...
   **/
  int setQuantTables(QIQuantTable *aQuantTable);
   ...
   **/
  inline uint16_t NumOfComponents()
  {
    return mNumOfComponents;
  }

  /** setNumOfComponents:
   *  @aNumOfComponents: Number of compoments in the image
   *
   *  sets the number of compoments in the input image
   **/
  inline void setNumOfComponents(uint16_t aNumOfComponents)
  {
