...
QImageHybridEncoder::~QImageHybridEncoder()
{
  ...
  (void)os_mutex_destroy_jpg(&mThreadCtrlBlk.output_handler_args.mutex);
  (void)os_cond_destroy_jpg(&mThreadCtrlBlk.output_handler_args.cond);
...
int QImageHybridEncoder::addInputImage(QImage &aImage)
{
  ...
  os_mutex_init_jpg(&p_thread_arg->output_handler_args.mutex);
  os_cond_init_jpg(&p_thread_arg->output_handler_args.cond);
