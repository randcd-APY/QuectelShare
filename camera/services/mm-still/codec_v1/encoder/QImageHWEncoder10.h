 ...
 *  @jpege_lib_set_userdata: set userdata
 *  @ptr : library handle
 *
...
class QImageHW10Encoder : public QImageEncoderInterface, public QThreadObject
{
  ...
  **/
  bool IsAvailable(QIEncodeParams& aParams, bool aExclusiveFlag);
  ...
  *  starts the encoder
  **/
  virtual int Start(QIThread *a_pUseEncThread = NULL);
...
private:
  ...
  **/
  ...
  /** mStaticJpegeLibHandle
  *
  *  Static userspace driver handle for exclusive HW
  **/
  static void* mStaticJpegeLibHandle;

  /** mStaticHandleUsedRefCnt
  *
  *  Static handle reference count
  **/
  static uint8_t mStaticHandleUsedRefCnt;

  /** mStaticMutex
  *
  *  Static mutex object
  **/
  static pthread_mutex_t mStaticMutex;
