...
** ----------------------------------------------------------------------- */
static const uint16_t div_q10[33]={1024, 1024, 512, 341, 256, 205, 171, 146, 128, 114, 102,
  93, 85, 79, 73, 68, 64, 60, 57, 54, 51, 49, 47, 45, 43, 41, 39, 38, 37, 35, 34, 33, 32};
...
void jpege_engine_sw_downscale_mcu_lines_fastCV(
    ...
    uint32_t        rotated_mcu_height)
{
  JPEG_DBG_HIGH("%s:%d] FastCV Disabled !!!", __func__, __LINE__);
  return;
}
#endif
