...
LOCAL_C_INCLUDES += $(WORKSPACE)/camera/services/mm-camera-legacy/mm-camera2/media-controller/mct/stream
LOCAL_C_INCLUDES += $(WORKSPACE)/camera/services/mm-camera-legacy/mm-camera2/media-controller/mct/object
LOCAL_C_INCLUDES += $(WORKSPACE)/camera/services/mm-camera-legacy/mm-camera2/media-controller/includes
LOCAL_C_INCLUDES += $(WORKSPACE)/camera/services/mm-camera-legacy/mm-camera2/media-controller/mct/tools
LOCAL_C_INCLUDES += $(WORKSPACE)/camera/services/mm-camera-legacy/mm-camera2/includes
LOCAL_C_INCLUDES += $(WORKSPACE)/camera/lib-legacy/QCamera2/stack/common
LOCAL_C_INCLUDES += $(WORKSPACE)/camera/services/mm-camera-legacy/mm-camera2/media-controller/mct/event
LOCAL_C_INCLUDES += $(WORKSPACE)/camera/services/mm-camera-legacy/mm-camera2/media-controller/mct/module
LOCAL_C_INCLUDES += $(WORKSPACE)/camera/services/mm-camera-legacy/mm-camera2/media-controller/mct/bus
LOCAL_C_INCLUDES += $(WORKSPACE)/camera/services/mm-camera-legacy/mm-camera2/media-controller/mct/port
LOCAL_C_INCLUDES += $(WORKSPACE)/camera/services/mm-camera-legacy/mm-camera2/server-tuning/tuning
