...
static void af_port_HAF_tuning_update(af_port_private_t *af_port,
...
static void af_port_HAF_tuning_update(af_port_private_t *af_port, af_tuning_haf_t *af_haf_tuning)
{
