...
#define QMI_QMUX_IF_CONN_SOCKET_PATH          "/dev/socket/qmux_radio/qmux_connect_socket"
#define QMI_QMUX_IF_CLIENT_SOCKET_PATH        "/dev/socket/qmux_radio/qmux_client_socket"
