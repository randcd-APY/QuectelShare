...
)
{
  ...
  switch (msg_id)
  {
    ...
    case QMI_CSVT_ACK_CALL_MODIFY_IND_V01:
      ...
      rc = qcci_legacy_qmi_client_message_decode(user_handle,
                                     QMI_IDL_INDICATION,
                                     msg_id,
                                     ind_buf,
                                     ind_buf_len,
...
)
{
  ...
  rc = qcci_legacy_qmi_client_init(conn_id,
                       info->csvt_srvc_obj,
                       qmi_csvt_common_ind_hdlr,
                       (void *)info,
                       &info->qmi_clnt_hndl);
...
)
{
  ...
  rc = qcci_legacy_qmi_client_release(info->qmi_clnt_hndl);
...
)
{
  ...
  *qmi_err_code = QMI_SERVICE_ERR_NONE;
  ...
  rc = qcci_legacy_qmi_client_send_msg_sync(info->qmi_clnt_hndl,
