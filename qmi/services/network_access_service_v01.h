...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //commercial/MPSS.HE.1.0.c1.3/Main/modem_proc/qmimsgs/nas/api/network_access_service_v01.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define NAS_V01_IDL_MINOR_VERS 0xDC
 ...
 */
  ...
  /**<  
       EN-DC indication in LTE SIB2. Values: \n
       - 0x00 -- SIB2 5G Not available \n
       - 0x01 -- SIB2 5G Available
    */
...
typedef struct {
  ...
  /**<  
     Current RSRP in dBm as measured by L1. 
     Range: -44 to -140 (-44 means -44 dBm, -140 means -140 dBm).
	 Invalid (e.g. least in int16 = -32768) means no more sending report.
 */
