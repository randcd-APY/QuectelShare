...
static const uint8_t wds_indication_register_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wds_indication_register_req_msg_v01, report_v2x_src_l2_info) - QMI_IDL_OFFSET16RELATIVE(wds_indication_register_req_msg_v01, report_v2x_src_l2_info_valid)),
  0x2E,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_1_BYTE,
...
static const qmi_idl_service_message_table_entry wds_service_command_messages_v01[] = {
  ...
  {QMI_WDS_INDICATION_REGISTER_REQ_V01, QMI_IDL_TYPE16(0, 7), 422},
