...
namespace GSCAN_TEST
{
    ...
    public:
        ...
        static const char *SSID_WHITE_LIST;
        static const char *ROAM_PARAMS;
        static const char *LAZY_ROAM;
        static const char *BSSID_PREFS;
    ...
    private:
        ...
        wifi_error gscanSendSSIDWhiteList(int argc, char **argv);
        wifi_error gscanSendGscanRoamParams(int argc, char **argv);
        wifi_error gscanSendEnableLazyRoam(int argc, char **argv);
        wifi_error gscanSendSetBssidPrefs(int argc, char **argv);
...
typedef enum {
    ...
    GSCAN_CMD_SET_SSID_HOTLIST,    /*11*/
    GSCAN_CMD_RESET_SSID_HOTLIST,
    GSCAN_CMD_SET_EPNO_LIST,
    GSCAN_CMD_SET_PASSPOINT_LIST,
    GSCAN_CMD_RESET_PASSPOINT_LIST,

    GSCAN_CMD_SSID_WHITE_LIST,    /*16*/
    GSCAN_CMD_ROAM_PARAMS,
    GSCAN_CMD_LAZY_ROAM,
    GSCAN_CMD_BSSID_PREFS,
