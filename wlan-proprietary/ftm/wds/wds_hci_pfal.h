...
typedef enum {
    VND_OP_FM_POWER_CTRL = 12,  /*FM_VND_OP_POWER_CTRL*/
    VND_OP_FM_USERIAL_OPEN,     /*BT_VND_OP_FM_USERIAL_OPEN*/
    VND_OP_FM_USERIAL_CLOSE,    /*BT_VND_OP_FM_USERIAL_CLOSE*/
} fm_vendor_opcode_t;
...
int port_init_libbt(unsigned char option);
int port_deinit_libbt(wdsdaemon *wds, unsigned char option);
