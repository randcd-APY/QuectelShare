...
set(CSR_ARM_COMPILER_VERSION "4.0")

if (DEFINED "ENV{RVCT40BIN}")
    set(CSR_ARM_PATH_BIN "$ENV{RVCT40BIN}")
    set(CSR_ARM_PATH_INC "$ENV{RVCT40INC}")
    set(CSR_ARM_PATH_LIB "$ENV{RVCT40LIB}")
else()
