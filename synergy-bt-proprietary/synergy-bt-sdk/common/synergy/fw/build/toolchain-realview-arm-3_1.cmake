...
set(CSR_ARM_COMPILER_VERSION "3.1")

if (DEFINED "ENV{RVCT31BIN}")
    set(CSR_ARM_PATH_BIN "$ENV{RVCT31BIN}")
    set(CSR_ARM_PATH_INC "$ENV{RVCT31INC}")
    set(CSR_ARM_PATH_LIB "$ENV{RVCT31LIB}")
else()
