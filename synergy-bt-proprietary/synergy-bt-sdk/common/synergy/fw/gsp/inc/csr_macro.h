...
#define CSR_CONVERT_8_FROM_XAP(output, input) \
    (output) = ((CsrUint8) (input)[0]);(input) += 1

#define CSR_CONVERT_16_FROM_XAP(output, input) \
    (output) = (CsrUint16) ((((CsrUint16) (input)[1]) << 8) | \
                            ((CsrUint16) (input)[0]));(input) += 2

#define CSR_CONVERT_24_FROM_XAP(output, input) \
    (output) = (((CsrUint32) (input)[2]) << 16) | \
               (((CsrUint32) (input)[1]) << 8) | \
               ((CsrUint32) (input)[0]);input += 3

/* [QTI] Update the macro to fit with ARM platform (little endian, 32bit or 64bit) */
#define CSR_CONVERT_32_FROM_XAP(output, input) \
    (output) = (((CsrUint32) (input)[3]) << 24) | \
               (((CsrUint32) (input)[2]) << 16) | \
               (((CsrUint32) (input)[1]) << 8) | \
               ((CsrUint32) (input)[0]);input += 4
