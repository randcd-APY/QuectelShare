...
$Header: //components/rel/mmcp.mpss/4.0/api/public/wms.h#8 $
$DateTime: 2013/07/03 08:25:45 $
$Author: coresvc $
*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
...
==========================================================================*/
/** @ingroup config_group_wms_cfg_set_routes
  ...
  The WMS keeps the routing configuration in NV. During power-up, the
...
===========================================================================*/
/** @ingroup config_group_wms_cfg_get_routes
...
===========================================================================*/
/** @ingroup config_group_wms_cfg_get_memory_status
  ...
  @param[in] user_data      Pointer provided by the client to uniquely identify
                            ...
                            pointer is passed to the client's callback function.
                            A NULL pointer is acceptable.
  @param[in] mem_store      Memory store from which to get the status.
  @param[in] tag            Type of messages for which memory usage status is
                            returned.
...
===========================================================================*/
/** @ingroup config_group_wms_cfg_get_message_list
  ...
  @param[in] user_data      Pointer provided by the client to uniquely identify
                            ...
                            pointer is passed to the client's callback function.
                            A NULL pointer is acceptable.
  @param[in] mem_store      Memory store from which to get the message list.
  @param[in] tag            Type of messages to be listed.
...
===========================================================================*/
/** @ingroup config_group_wms_cfg_set_gw_domain_pref
...
===========================================================================*/
/** @ingroup config_group_wms_cfg_get_gw_domain_pref
...
===========================================================================*/
/** @ingroup config_group_wms_cfg_set_primary_client
  ...
  @param[in] user_data      Pointer provided by the client to uniquely identify
                            ...
                            pointer is passed to the client's callback function.
                            A NULL pointer is acceptable.
  @param[in] set_primary    Indicates whether to set/reset the primary client.
  @param[in] use_client_memory  Indicates whether to use client's memory store.
...
===========================================================================*/
/** @ingroup config_group_wms_cfg_set_memory_full
  ...
  @param[in] user_data      Pointer provided by the client to uniquely identify
                            ...
                            pointer is passed to the client's callback function.
                            A NULL pointer is acceptable.
  @param[in] memory_full    Sets/resets the memory full flag of the client memory.
...
===========================================================================*/
/** @ingroup config_group_wms_cfg_set_link_control
  ...
  - WMS_LINK_CONTROL_DISABLED -- Disable link control so the lower layer can
    release the link if there is no MO SMS to send.
  ...
  @param[in] user_data      Pointer provided by the client to uniquely identify
                            ...
                            pointer is passed to the client's callback function.
                            A NULL pointer is acceptable.
  @param[in] control_option  Link control option.
...
===========================================================================*/
/** @ingroup config_group_wms_cfg_get_link_control
...
===========================================================================*/
/** @ingroup messaging_group_wms_msg_send
  Sends an MO SMS message to the SMS entity as specified by the
...
===========================================================================*/
/** @ingroup messaging_group_wms_msg_ack
  ...
  @param[in] user_data      Pointer provided by the client to uniquely identify
                            ...
                            pointer is passed to the client's callback function.
                            A NULL pointer is acceptable.
  @param[in] ack_info_ptr   Pointer to the ACK information.
...
===========================================================================*/
/** @ingroup messaging_group_wms_msg_read
...
===========================================================================*/
/** @ingroup messaging_group_wms_msg_read_sts_report
...
===========================================================================*/
/** @ingroup messaging_group_wms_msg_write
...
===========================================================================*/
/** @ingroup messaging_group_wms_msg_delete
...
===========================================================================*/
/** @ingroup messaging_group_wms_msg_delete_all
  ...
  @param[in] user_data      Pointer provided by the client to uniquely identify
                            ...
                            A NULL pointer is acceptable.
  @param[in] mem_store      Memory store from which to read the message.
  @param[in] tag            Type of message to be deleted.
...
===========================================================================*/
/** @ingroup messaging_group_wms_msg_modify_tag
...
===========================================================================*/
/** @ingroup messaging_group_wms_msg_read_template
...
===========================================================================*/
/** @ingroup messaging_group_wms_msg_write_template
  Writes a template.
  ...
  @param[in] user_data      Pointer provided by the client to uniquely identify
                            ...
                            pointer is passed to the client's callback function.
                            A NULL pointer is acceptable.
  @param[in] write_mode     Mode for storing the template.
  @param[in] message_ptr    Pointer to the client's SMS message buffer. The API
...
===========================================================================*/
/** @ingroup messaging_group_wms_msg_delete_template
...
===========================================================================*/
/** @ingroup messaging_group_wms_msg_delete_template_all
...
===========================================================================*/
/** @ingroup messaging_group_wms_msg_write_sts_report
  Writes a status report to a memory store.

  A corresponding MO SMS message must be present in the same
  ...
  @param[in] user_data      Pointer provided by the client to uniquely identify
                            ...
                            pointer is passed to the client's callback function.
                            A NULL pointer is acceptable.
  @param[in] write_mode     Mode for storing the status report.
  @param[in] message_ptr    Pointer to the client's SMS message buffer. The API
                            must copy the data in this buffer into its own
                            buffer so the client can reuse it after the function
                            returns.
...
===========================================================================*/
/** @ingroup messaging_group_wms_msg_delete_sts_report
...
===========================================================================*/
/** @ingroup messaging_group_wms_msg_delete_sts_report_all
...
===========================================================================*/
/** @ingroup mmbroadcast_group_wms_bc_mm_get_config
...
===========================================================================*/
/** @ingroup mmbroadcast_group_wms_bc_mm_get_pref
...
===========================================================================*/
/** @ingroup mmbroadcast_group_wms_bc_mm_set_pref
...
===========================================================================*/
/** @ingroup mmbroadcast_group_wms_bc_mm_get_table
...
===========================================================================*/
/** @ingroup mmbroadcast_group_wms_bc_mm_select_service
...
===========================================================================*/
/** @ingroup mmbroadcast_group_wms_bc_mm_get_all_service_ids
...
===========================================================================*/
/** @ingroup mmbroadcast_group_wms_bc_mm_get_service_info
...
===========================================================================*/
/** @ingroup mmbroadcast_group_wms_bc_mm_add_services
...
===========================================================================*/
/** @ingroup mmbroadcast_group_wms_bc_mm_delete_services
...
===========================================================================*/
/** @ingroup mmbroadcast_group_wms_bc_mm_change_service_info
...
===========================================================================*/
/** @ingroup mmbroadcast_group_wms_bc_mm_delete_all_services
...
===========================================================================*/
/** @ingroup mmbroadcast_group_wms_bc_mm_select_all_services
  Selects/deselects all entries in the broadcast SMS service table.
...
===========================================================================*/
/** @ingroup mmbroadcast_group_wms_bc_mm_set_priority_for_all_services
...
===========================================================================*/
/** @ingroup mmbroadcast_group_wms_bc_mm_msg_delete_indication
...
===========================================================================*/
/** @ingroup mmbroadcast_group_wms_bc_mm_msg_delete_all_indication
...
===========================================================================*/
/** @ingroup mmbroadcast_group_wms_bc_mm_get_reading_pref
...
===========================================================================*/
/** @ingroup mmbroadcast_group_wms_bc_mm_set_reading_pref
