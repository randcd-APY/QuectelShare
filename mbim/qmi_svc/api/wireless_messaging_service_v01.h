...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
 ...
 Qualcomm Technologies Proprietary and Confidential.
  ...
  $Header: //source/qcom/qct/interfaces/qmi/wms/main/latest/api/wireless_messaging_service_v01.h#7 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define WMS_V01_IDL_MINOR_VERS 0x08
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define WMS_V01_IDL_TOOL_VERS 0x05
/** Maximum Defined Message ID */
#define WMS_V01_MAX_MESSAGE_ID 0x005E;
/**
    @}
  */
...
typedef struct {
  ...
  /**<   Send status. Values: \n
    ...
    -QMI_ERR_CAUSE_CODE -- SMS cause code: For CDMA, see
                           \hyperref[S4]{[S4]},
                           Section 6.5.2.125;\n
                           for GW, see \hyperref[S3]{[S3]},
                           Section 3.2.5 \n
