...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
 ...
 Qualcomm Technologies Proprietary and Confidential.
  ...
  $Header: //source/qcom/qct/interfaces/qmi/cat/main/latest/api/card_application_toolkit_v02.h#10 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define CAT_V02_IDL_MINOR_VERS 0x0C
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define CAT_V02_IDL_TOOL_VERS 0x05
...
typedef struct {
  ...
  /**<   DTMF data in BCD format (two digits encoded in one byte) (see \hyperref[S1]{[S1]}, Section 8.44). */
...
typedef struct {
  ...
  /**<   Text of USSD string (see \hyperref[S4]{[S4]}, Section 8.17).
   */
...
typedef struct {
  ...
  /**<   Provide Local Information proactive command, encoded as in \hyperref[S1]{[S1]}, Section 6.6.15. */
...
typedef struct {
  ...
  uint8_t speed;
  /**<   Data rate; same as the speed subparameter defined in \hyperref[S5]{[S5]}, Section 6.7. */
...
typedef struct {
  ...
  uint8_t delay_cls;
  /**<   Delay class; same as the delay subparameter defined in \hyperref[S4]{[S4]}, Section 8.52.2. */

  uint8_t reliability_cls;
  /**<   Reliability class; same as the reliability subparameter defined in \hyperref[S4]{[S4]}, Section 8.52.2. */

  uint8_t peak_throughput;
  /**<   Peak throughput class; same as the peak subparameter defined in \hyperref[S4]{[S4]}, Section 8.52.2. */
...
typedef struct {
  ...
  /**<   Browser termination cause: \n
       - 0x00000000 -- CAT_BROWSER_TERM_CAUSE_TYPE_USER_TERMINATED -- User terminated the browser \n
       - 0x00000001 -- CAT_BROWSER_TERM_CAUSE_TYPE_ERROR -- Browser terminated due to error
   */
