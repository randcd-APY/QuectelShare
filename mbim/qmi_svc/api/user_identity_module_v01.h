...
/* This file was generated with Tool version 6.14.7 
   It was generated on: Fri Oct 27 2017 (Spin 0)
...
#define UIM_V01_IDL_MINOR_VERS 0x50
 ...
 */
  ...
  uint8_t num_app;
  /**<   Number of valid application present in EF-DIR of card.  */
  ...
  uint8_t is_euicc;
  /**<   Indicates whether card is eUICC card or not based on ATR. Values: \n
        0 - Not an eUICC card \n
        1 - eUICC card
   */
...
typedef struct {
  ...
  */
  ...
  /**<   Additional information of the various physical slots on the device.\n
       The number of elements correspond with the number of physical slots
       on the device.
    */
...
typedef enum {
  ...
  UIM_REMOTE_UNLOCK_GET_MAX_SUPPORTED_VERSION_V01 = 0x03, /**<  Retrieve highest major and minor version of the incoming blob supported
       by simlock  */
...
typedef struct {
  ...
  /**<   Indicates the operation to be performed. Valid values:\n
      ...
      - UIM_REMOTE_UNLOCK_GET_MAX_SUPPORTED_VERSION (0x03) --  Retrieve highest major and minor version of the incoming blob supported
       by simlock  */
...
typedef struct {
  ...
  /**<   Highest major version of blob that is supported by simlock */

  uint8_t minor_version;
  /**<   Highest minor version of blob that is supported by simlock */
