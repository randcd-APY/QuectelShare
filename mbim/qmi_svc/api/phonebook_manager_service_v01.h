...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
 ...
 Qualcomm Technologies Proprietary and Confidential.
  ...
  $Header: //source/qcom/qct/interfaces/qmi/pbm/main/latest/api/phonebook_manager_service_v01.h#5 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define PBM_V01_IDL_MINOR_VERS 0x08
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define PBM_V01_IDL_TOOL_VERS 0x04
/** Maximum Defined Message ID */
#define PBM_V01_MAX_MESSAGE_ID 0x001B;
/**
    @}
  */
...
#define PBM_CARD_PIN1_V01 ((pbm_pin_mask_type_v01)0x01)
#define PBM_CARD_PIN2_V01 ((pbm_pin_mask_type_v01)0x02)
#define PBM_CARD_ADM1_V01 ((pbm_pin_mask_type_v01)0x04)
#define PBM_CARD_ADM2_V01 ((pbm_pin_mask_type_v01)0x08)
/** @addtogroup pbm_qmi_enums
    @{
  */
typedef enum {
...
typedef struct {
  ...
  /**<   Protection Methods are provided in @latexonly\ref{tbl:pbm_protection_method}@endlatexonly.  */
