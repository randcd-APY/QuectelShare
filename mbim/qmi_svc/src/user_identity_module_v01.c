...
static const uint8_t uim_remote_unlock_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_remote_unlock_req_msg_v01, operation) - QMI_IDL_OFFSET16RELATIVE(uim_remote_unlock_req_msg_v01, operation_valid)),
  0x11,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
...
static const uint8_t uim_remote_unlock_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(uim_remote_unlock_resp_msg_v01, maximum_version) - QMI_IDL_OFFSET16RELATIVE(uim_remote_unlock_resp_msg_v01, maximum_version_valid)),
  0x13,
   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
...
static const qmi_idl_service_message_table_entry uim_service_command_messages_v01[] = {
  ...
  {QMI_UIM_REMOTE_UNLOCK_REQ_V01, QMI_IDL_TYPE16(0, 131), 1036},
...
static const qmi_idl_service_message_table_entry uim_service_response_messages_v01[] = {
  ...
  {QMI_UIM_REMOTE_UNLOCK_RESP_V01, QMI_IDL_TYPE16(0, 132), 1690},
