...
GENERAL DESCRIPTION
 ...
 Qualcomm Technologies Proprietary and Confidential.
  ...
  $Header: //source/qcom/qct/interfaces/qmi/wms/main/latest/src/wireless_messaging_service_v01.c#7 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 5.1
   ...
   It was generated on: Tue Apr 24 2012
...
static const uint8_t wms_set_event_report_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wms_set_event_report_req_msg_v01, report_mt_message) - QMI_IDL_OFFSET8(wms_set_event_report_req_msg_v01, report_mt_message_valid)),
  0x10,
  QMI_IDL_GENERIC_1_BYTE,
...
static const uint8_t wms_event_report_ind_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wms_event_report_ind_msg_v01, sms_on_ims) - QMI_IDL_OFFSET16RELATIVE(wms_event_report_ind_msg_v01, sms_on_ims_valid)),
  0x16,
...
static const uint8_t wms_raw_send_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wms_raw_send_req_msg_v01, retry_message_id) - QMI_IDL_OFFSET16RELATIVE(wms_raw_send_req_msg_v01, retry_message_id_valid)),
  0x15,
...
static const uint8_t wms_async_raw_send_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wms_async_raw_send_req_msg_v01, user_data) - QMI_IDL_OFFSET16RELATIVE(wms_async_raw_send_req_msg_v01, user_data_valid)),
  0x16,
  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
...
static const qmi_idl_service_message_table_entry wms_service_command_messages_v01[] = {
  {QMI_WMS_RESET_REQ_V01, TYPE16(0, 0), 0},
  {QMI_WMS_SET_EVENT_REPORT_REQ_V01, TYPE16(0, 2), 4},
  {QMI_WMS_RAW_SEND_REQ_V01, TYPE16(0, 5), 289},
  {QMI_WMS_RAW_WRITE_REQ_V01, TYPE16(0, 7), 262},
  {QMI_WMS_RAW_READ_REQ_V01, TYPE16(0, 9), 16},
  {QMI_WMS_MODIFY_TAG_REQ_V01, TYPE16(0, 11), 13},
  {QMI_WMS_DELETE_REQ_V01, TYPE16(0, 13), 19},
  {QMI_WMS_GET_MESSAGE_PROTOCOL_REQ_V01, TYPE16(0, 15), 0},
  {QMI_WMS_LIST_MESSAGES_REQ_V01, TYPE16(0, 17), 12},
  {QMI_WMS_SET_ROUTES_REQ_V01, TYPE16(0, 19), 49},
  {QMI_WMS_GET_ROUTES_REQ_V01, TYPE16(0, 21), 0},
  {QMI_WMS_GET_SMSC_ADDRESS_REQ_V01, TYPE16(0, 23), 0},
  {QMI_WMS_SET_SMSC_ADDRESS_REQ_V01, TYPE16(0, 25), 30},
  {QMI_WMS_GET_STORE_MAX_SIZE_REQ_V01, TYPE16(0, 27), 8},
  {QMI_WMS_SEND_ACK_REQ_V01, TYPE16(0, 29), 23},
  {QMI_WMS_SET_RETRY_PERIOD_REQ_V01, TYPE16(0, 31), 7},
  {QMI_WMS_SET_RETRY_INTERVAL_REQ_V01, TYPE16(0, 33), 7},
  {QMI_WMS_SET_DC_DISCONNECT_TIMER_REQ_V01, TYPE16(0, 35), 7},
  {QMI_WMS_SET_MEMORY_STATUS_REQ_V01, TYPE16(0, 37), 4},
  {QMI_WMS_SET_BROADCAST_ACTIVATION_REQ_V01, TYPE16(0, 39), 5},
  {QMI_WMS_SET_BROADCAST_CONFIG_REQ_V01, TYPE16(0, 41), 514},
  {QMI_WMS_GET_BROADCAST_CONFIG_REQ_V01, TYPE16(0, 43), 4},
  {QMI_WMS_GET_DOMAIN_PREF_REQ_V01, TYPE16(0, 46), 0},
  {QMI_WMS_SET_DOMAIN_PREF_REQ_V01, TYPE16(0, 48), 4},
  {QMI_WMS_SEND_FROM_MEM_STORE_REQ_V01, TYPE16(0, 50), 13},
  {QMI_WMS_GET_MESSAGE_WAITING_REQ_V01, TYPE16(0, 52), 0},
  {QMI_WMS_SET_PRIMARY_CLIENT_REQ_V01, TYPE16(0, 55), 4},
  {QMI_WMS_INDICATION_REGISTER_REQ_V01, TYPE16(0, 58), 20},
  {QMI_WMS_GET_TRANSPORT_LAYER_INFO_REQ_V01, TYPE16(0, 60), 0},
  {QMI_WMS_GET_TRANSPORT_NW_REG_INFO_REQ_V01, TYPE16(0, 63), 0},
  {QMI_WMS_BIND_SUBSCRIPTION_REQ_V01, TYPE16(0, 66), 4},
  {QMI_WMS_GET_INDICATION_REGISTER_REQ_V01, TYPE16(0, 68), 0},
  {QMI_WMS_GET_SMS_PARAMETERS_REQ_V01, TYPE16(0, 70), 4},
  {QMI_WMS_SET_SMS_PARAMETERS_REQ_V01, TYPE16(0, 72), 32},
  {QMI_WMS_GET_DOMAIN_PREF_CONFIG_REQ_V01, TYPE16(0, 75), 0},
  {QMI_WMS_SET_DOMAIN_PREF_CONFIG_REQ_V01, TYPE16(0, 77), 8},
  {QMI_WMS_GET_RETRY_PERIOD_REQ_V01, TYPE16(0, 79), 0},
  {QMI_WMS_GET_RETRY_INTERVAL_REQ_V01, TYPE16(0, 81), 0},
  {QMI_WMS_GET_DC_DISCONNECT_TIMER_REQ_V01, TYPE16(0, 83), 0},
  {QMI_WMS_GET_MEMORY_STATUS_REQ_V01, TYPE16(0, 85), 0},
  {QMI_WMS_GET_PRIMARY_CLIENT_REQ_V01, TYPE16(0, 87), 0},
  {QMI_WMS_GET_SUBSCRIPTION_BINDING_REQ_V01, TYPE16(0, 89), 0},
  {QMI_WMS_ASYNC_RAW_SEND_REQ_V01, TYPE16(0, 91), 296},
  {QMI_WMS_ASYNC_SEND_ACK_REQ_V01, TYPE16(0, 94), 30},
  {QMI_WMS_ASYNC_SEND_FROM_MEM_STORE_REQ_V01, TYPE16(0, 97), 20},
  {QMI_WMS_GET_SERVICE_READY_STATUS_REQ_V01, TYPE16(0, 100), 0}
};

static const qmi_idl_service_message_table_entry wms_service_response_messages_v01[] = {
  {QMI_WMS_RESET_RESP_V01, TYPE16(0, 1), 7},
  {QMI_WMS_SET_EVENT_REPORT_RESP_V01, TYPE16(0, 3), 7},
  {QMI_WMS_RAW_SEND_RESP_V01, TYPE16(0, 6), 294},
  {QMI_WMS_RAW_WRITE_RESP_V01, TYPE16(0, 8), 14},
  {QMI_WMS_RAW_RESP_MSG_V01, TYPE16(0, 10), 269},
  {QMI_WMS_MODIFY_TAG_RESP_V01, TYPE16(0, 12), 7},
  {QMI_WMS_DELETE_RESP_V01, TYPE16(0, 14), 7},
  {QMI_WMS_GET_MESSAGE_PROTOCOL_RESP_V01, TYPE16(0, 16), 11},
  {QMI_WMS_LIST_MESSAGES_RESP_V01, TYPE16(0, 18), 1289},
  {QMI_WMS_SET_ROUTES_RESP_V01, TYPE16(0, 20), 7},
  {QMI_WMS_GET_ROUTES_RESP_V01, TYPE16(0, 22), 56},
  {QMI_WMS_GET_SMSC_ADDRESS_RESP_V01, TYPE16(0, 24), 35},
  {QMI_WMS_SET_SMSC_ADDRESS_RESP_V01, TYPE16(0, 26), 7},
  {QMI_WMS_GET_STORE_MAX_SIZE_RESP_V01, TYPE16(0, 28), 21},
  {QMI_WMS_SEND_ACK_RESP_V01, TYPE16(0, 30), 11},
  {QMI_WMS_SET_RETRY_PERIOD_RESP_V01, TYPE16(0, 32), 7},
  {QMI_WMS_SET_RETRY_INTERVAL_RESP_V01, TYPE16(0, 34), 7},
  {QMI_WMS_SET_DC_DISCONNECT_TIMER_RESP_V01, TYPE16(0, 36), 7},
  {QMI_WMS_SET_MEMORY_STATUS_RESP_V01, TYPE16(0, 38), 7},
  {QMI_WMS_SET_BROADCAST_ACTIVATION_RESP_V01, TYPE16(0, 40), 7},
  {QMI_WMS_SET_BROADCAST_CONFIG_RESP_V01, TYPE16(0, 42), 7},
  {QMI_WMS_GET_BROADCAST_CONFIG_RESP_V01, TYPE16(0, 44), 519},
  {QMI_WMS_GET_DOMAIN_PREF_RESP_V01, TYPE16(0, 47), 11},
  {QMI_WMS_SET_DOMAIN_PREF_RESP_V01, TYPE16(0, 49), 7},
  {QMI_WMS_SEND_FROM_MEM_STORE_RESP_V01, TYPE16(0, 51), 31},
  {QMI_WMS_GET_MESSAGE_WAITING_RESP_V01, TYPE16(0, 53), 776},
  {QMI_WMS_SET_PRIMARY_CLIENT_RESP_V01, TYPE16(0, 56), 7},
  {QMI_WMS_INDICATION_REGISTER_RESP_V01, TYPE16(0, 59), 7},
  {QMI_WMS_GET_TRANSPORT_LAYER_INFO_RESP_V01, TYPE16(0, 61), 16},
  {QMI_WMS_GET_TRANSPORT_NW_REG_INFO_RESP_V01, TYPE16(0, 64), 11},
  {QMI_WMS_BIND_SUBSCRIPTION_RESP_V01, TYPE16(0, 67), 7},
  {QMI_WMS_GET_INDICATION_REGISTER_RESP_V01, TYPE16(0, 69), 27},
  {QMI_WMS_GET_SMS_PARAMETERS_RESP_V01, TYPE16(0, 71), 35},
  {QMI_WMS_SET_SMS_PARAMETERS_RESP_V01, TYPE16(0, 73), 7},
  {QMI_WMS_GET_DOMAIN_PREF_CONFIG_RESP_V01, TYPE16(0, 76), 15},
  {QMI_WMS_SET_DOMAIN_PREF_CONFIG_RESP_V01, TYPE16(0, 78), 17},
  {QMI_WMS_GET_RETRY_PERIOD_RESP_V01, TYPE16(0, 80), 14},
  {QMI_WMS_GET_RETRY_INTERVAL_RESP_V01, TYPE16(0, 82), 14},
  {QMI_WMS_GET_DC_DISCONNECT_TIMER_RESP_V01, TYPE16(0, 84), 14},
  {QMI_WMS_GET_MEMORY_STATUS_RESP_V01, TYPE16(0, 86), 11},
  {QMI_WMS_GET_PRIMARY_CLIENT_RESP_V01, TYPE16(0, 88), 11},
  {QMI_WMS_GET_SUBSCRIPTION_BINDING_RESP_V01, TYPE16(0, 90), 11},
  {QMI_WMS_ASYNC_RAW_SEND_RESP_V01, TYPE16(0, 92), 7},
  {QMI_WMS_ASYNC_SEND_ACK_RESP_V01, TYPE16(0, 95), 7},
  {QMI_WMS_ASYNC_SEND_FROM_MEM_STORE_RESP_V01, TYPE16(0, 98), 7},
  {QMI_WMS_GET_SERVICE_READY_STATUS_RESP_V01, TYPE16(0, 101), 18}
};

static const qmi_idl_service_message_table_entry wms_service_indication_messages_v01[] = {
  {QMI_WMS_EVENT_REPORT_IND_V01, TYPE16(0, 4), 1562},
  {QMI_WMS_MEMORY_FULL_IND_V01, TYPE16(0, 45), 5},
  {QMI_WMS_MESSAGE_WAITING_IND_V01, TYPE16(0, 54), 769},
  {QMI_WMS_SMSC_ADDRESS_IND_V01, TYPE16(0, 57), 28},
  {QMI_WMS_TRANSPORT_LAYER_INFO_IND_V01, TYPE16(0, 62), 9},
  {QMI_WMS_TRANSPORT_NW_REG_INFO_IND_V01, TYPE16(0, 65), 4},
  {QMI_WMS_CALL_STATUS_IND_V01, TYPE16(0, 74), 4},
  {QMI_WMS_ASYNC_RAW_SEND_IND_V01, TYPE16(0, 93), 299},
  {QMI_WMS_ASYNC_SEND_ACK_IND_V01, TYPE16(0, 96), 16},
  {QMI_WMS_ASYNC_SEND_FROM_MEM_STORE_IND_V01, TYPE16(0, 99), 299},
  {QMI_WMS_SERVICE_READY_IND_V01, TYPE16(0, 102), 7},
  {QMI_WMS_BROADCAST_CONFIG_IND_V01, TYPE16(0, 103), 516}
};

/*Service Object*/
const struct qmi_idl_service_object wms_qmi_idl_service_object_v01 = {
  0x04,
  0x01,
  0x05,
  1562,
