...
#define DVP_ASSERT_EQUAL(x, y)      vDvpTb_Assert(((x) == (y)), __LINE__, "DVP_ASSERT_EQUAL(" #x ", " #y ")", __FILE__, __func__)
#define DVP_ASSERT_NEQUAL(x, y)     vDvpTb_Assert(((x) != (y)), __LINE__, "DVP_ASSERT_NEQUAL(" #x ", " #y ")", __FILE__, __func__)
#define DVP_ASSERT_PTR_EQUAL(x, y)  vDvpTb_Assert((((void *)x) == ((void *)y)), __LINE__, "DVP_ASSERT_PTR_EQUAL(" #x ", " #y ")", __FILE__, __func__)
#define DVP_ASSERT_PTR_NEQUAL(x, y) vDvpTb_Assert((((void *)x) != ((void *)y)), __LINE__, "DVP_ASSERT_PTR_NEQUAL(" #x ", " #y ")", __FILE__, __func__)
#define DVP_ASSERT_PTR_NULL(x)      vDvpTb_Assert((((void *)x) == NULL), __LINE__, "DVP_ASSERT_PTR_NULL(" #x ")", __FILE__, __func__)
#define DVP_ASSERT_PTR_NNULL(x)     vDvpTb_Assert((((void *)x) != NULL), __LINE__, "DVP_ASSERT_PTR_NULL(" #x ")", __FILE__, __func__)
