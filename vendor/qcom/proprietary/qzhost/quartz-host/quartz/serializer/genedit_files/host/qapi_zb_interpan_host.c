        ...
        if(qsResult == ssSuccess)
        {
            ...
            if(SendCommand(&qsInputBuffer, &qsOutputBuffer) == ssSuccess)
            {
                if(qsOutputBuffer.Start != NULL)
                {
                    ...
                    if(qsRetVal == QAPI_OK)
                        qsResult = Callback_UpdateKey(qsCbParam, (uint32_t)InterPAN_Event_CB);
                    else
        ...
        if(qsResult == ssSuccess)
        {
            ...
            if(SendCommand(&qsInputBuffer, &qsOutputBuffer) == ssSuccess)
            {
                if(qsOutputBuffer.Start != NULL)
                {
                    ...
                    if(qsRetVal == QAPI_OK)
                        Callback_UnregisterByKey(MODULE_ZB, QAPI_ZB_INTERPAN_FILE_ID, QAPI_ZB_INTERPAN_EVENT_CB_T_CALLBACK_ID, (uint32_t)InterPAN_Event_CB);
