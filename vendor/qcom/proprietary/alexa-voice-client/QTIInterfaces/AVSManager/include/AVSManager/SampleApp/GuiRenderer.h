...
#ifndef ALEXA_CLIENT_SDK_SAMPLE_APP_INCLUDE_AVSMANAGER_GUI_RENDERER_H_
#define ALEXA_CLIENT_SDK_SAMPLE_APP_INCLUDE_AVSMANAGER_GUI_RENDERER_H_
...
#endif  // ALEXA_CLIENT_SDK_SAMPLE_APP_INCLUDE_AVSMANAGER_GUI_RENDERER_H_
