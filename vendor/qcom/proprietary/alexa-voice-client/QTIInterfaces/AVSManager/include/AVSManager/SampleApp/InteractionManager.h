...
private:
    ...
    std::shared_ptr<alexaClientSDK::mediaPlayer::MediaPlayer> m_mp3MediaPlayer;
    std::shared_ptr<alexaClientSDK::mediaPlayer::MediaPlayer> m_audioPlayerMediaPlayer;

    /// The default SDK client.
    std::weak_ptr<defaultClient::DefaultClient> m_client;

    /// The microphone managing object.
    // std::shared_ptr<sampleApp::PortAudioMicrophoneWrapper> m_micWrapper;

    /// The user interface manager.
    std::shared_ptr<avsManager::UIManager> m_userInterface;
