...
scan-build.stamp: $(HFILE_GLOB) $(CFILE_GLOB)
	...
	@if grep -l '^..*$$' $(DOC_MODULE).types > /dev/null; then	\
	    ...
	    $(GTKDOC_EXTRA_ENVIRONMENT) GST_PLUGIN_SCANNER_1_0=$(top_builddir)/libs/gst/helpers/gst-plugin-scanner-dummy GST_PLUGIN_SCANNER_1_0=$(top_builddir)/libs/gst/helpers/gst-plugin-scanner-dummy GST_PLUGIN_SCANNER_1_0=$(top_builddir)/libs/gst/helpers/gst-plugin-scanner-dummy					\
