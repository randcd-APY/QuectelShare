...
enum tftp_socket_result_type
tftp_socket_set_tx_timeout (tftp_socket *socket_handle, uint32 timeout_ms)
{
  enum tftp_socket_result_type sock_res = TFTP_SOCKET_RESULT_FAILED;
  int result;
  struct timeval sock_timeout;

  sock_timeout.tv_sec = timeout_ms / 1000;
  sock_timeout.tv_usec = (timeout_ms % 1000 ) * 1000;

  result = setsockopt (*socket_handle, SOL_SOCKET, SO_SNDTIMEO,
